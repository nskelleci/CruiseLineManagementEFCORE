...
namespace CruiseLineManagementEFCORE.Module.E2E.Tests;

public class CruiseLineManagementEFCORETests : IDisposable {
    const string BlazorAppName = "CruiseLineManagementEFCOREBlazor";
    const string WinAppName = "CruiseLineManagementEFCOREWin";
    const string AppDBName = "CruiseLineManagementEFCORE";
    EasyTestFixtureContext FixtureContext { get; } = new EasyTestFixtureContext();

	public CruiseLineManagementEFCORETests() {
        FixtureContext.RegisterApplications(
            new BlazorApplicationOptions(BlazorAppName, string.Format(@"{0}\..\..\..\..\CruiseLineManagementEFCORE.Blazor.Server", Environment.CurrentDirectory)),
            new WinApplicationOptions(WinAppName, string.Format(@"{0}\..\..\..\..\CruiseLineManagementEFCORE.Win\bin\EasyTest\net8.0-windows\CruiseLineManagementEFCORE.Win.exe", Environment.CurrentDirectory))
        );
        FixtureContext.RegisterDatabases(new DatabaseOptions(AppDBName, "CruiseLineManagementEFCOREEasyTest", server: @"(localdb)\mssqllocaldb"));
	}
    public void Dispose() {
