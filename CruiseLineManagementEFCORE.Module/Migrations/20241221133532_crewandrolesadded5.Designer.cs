...
namespace CruiseLineManagementEFCORE.Module.Migrations
{
    ...
    [Migration("20241221133532_crewandrolesadded5")]
    partial class crewandrolesadded5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrewRoleCrewUser", b =>
                {
                    b.Property<Guid>("CrewRolesID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CrewUsersID")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CrewRolesID", "CrewUsersID");

                    b.HasIndex("CrewUsersID");

                    b.ToTable("CrewRoleCrewUser");
                });
            ...
            modelBuilder.Entity("GlobalRoleGlobalUser", b =>
                {
                    ...
                    b.HasKey("GlobalRolesID", "GlobalUsersID");
            ...
            modelBuilder.Entity("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewRole", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CrewRole");
                });
            ...
            modelBuilder.Entity("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewObjects.CrewUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CrewUser");
                });
            ...
            modelBuilder.Entity("CrewRoleCrewUser", b =>
                {
                    b.HasOne("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewRole", null)
                        .WithMany()
                        .HasForeignKey("CrewRolesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewObjects.CrewUser", null)
                        .WithMany()
                        .HasForeignKey("CrewUsersID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewObjects.Crew", b =>
                {
                    b.HasOne("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewObjects.CrewUser", "CrewUser")
                        .WithOne("Crew")
                        .HasForeignKey("CruiseLineManagementEFCORE.Module.BusinessObjects.CrewObjects.Crew", "ID")
